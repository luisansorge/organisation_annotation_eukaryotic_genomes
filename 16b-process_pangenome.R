...
# 0) Inputs
# -----------------
wd <- "C:/Users/luisa/Desktop/BeFri/Fall Semester 2025/Fr_Organisation and annotation of genomes" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "Abd_0" # Your focal accession name
